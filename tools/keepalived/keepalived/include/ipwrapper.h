...
#define LVS_CMD_ADD_ZONE	IP_VS_SO_SET_ADDZONE
#define LVS_CMD_DEL_ZONE	IP_VS_SO_SET_DELZONE
...
extern int clear_zones(void);
extern int init_zones(void);
extern int clear_diff_zones(void);
