...
/* The argument to IP_VS_SO_GET_ZONE */
struct ip_vs_zone_entry_kern {
...
struct ip_vs_get_zones_kern {
	/* number of virtual services */
	unsigned int		num_zones;

	/* service table */
	struct ip_vs_zone_entry_kern entrytable[0];
};



struct ip_vs_zone_kern {
...
struct ip_vs_get_laddrs {
	__be32			__addr_v4;	/* zone address - internal use only */
	__be32			netmask;	/* zone address - internal use only */
...
extern struct nla_policy ipvs_zone_policy[IPVS_ZONE_ATTR_MAX + 1];
#endif
