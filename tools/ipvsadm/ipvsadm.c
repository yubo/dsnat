...
#define CMD_ADDZONE		(CMD_NONE+18)
#define CMD_DELZONE		(CMD_NONE+19)
#define CMD_MAX			CMD_DELZONE
...
{
	/*   -n   -c   svc  -s   -p   -M   -r   fwd  -w   -x   -y   -mc  tot  dmn  -st  -rt  thr  -pc  srt  sid  -ex  ops  pe   laddr syn zone*/
/*ADD*/     {'x', 'x', '+', ' ', ' ', ' ', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', ' ', 'x', 'x', ' ', 'x'},
/*EDIT*/    {'x', 'x', '+', ' ', ' ', ' ', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', ' ', 'x', 'x', ' ', 'x'},
/*DEL*/     {'x', 'x', '+', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'},
/*FLUSH*/   {'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'},
/*LIST*/    {' ', '1', '1', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', '1', '1', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'x', 'x', 'x', 'x', 'x'},
/*ADDSRV*/  {'x', 'x', '+', 'x', 'x', 'x', '+', ' ', ' ', ' ', ' ', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'},
/*DELSRV*/  {'x', 'x', '+', 'x', 'x', 'x', '+', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'},
/*EDITSRV*/ {'x', 'x', '+', 'x', 'x', 'x', '+', ' ', ' ', ' ', ' ', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'},
/*TIMEOUT*/ {'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'},
/*STARTD*/  {'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', ' ', 'x', 'x', 'x', 'x', 'x', 'x', 'x', ' ', 'x', 'x', 'x', 'x', 'x', 'x'},
/*STOPD*/   {'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', ' ', 'x', 'x', 'x', 'x', 'x', 'x'},
/*RESTORE*/ {'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'},
/*SAVE*/    {' ', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'},
/*ZERO*/    {'x', 'x', ' ', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', ' '},
/*ADDLADDR*/{'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', '+', 'x', '+'},
/*DELLADDR*/{'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', '+', 'x', '+'},
/*GETLADDR*/{'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', ' '},
/*ADDZONE*/ {'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', '+'},
/*DELZONE*/ {'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', '+'},
};
...
#define ZONE_NONE		0x0000
#define ZONE_ADDR		0x0001
...
static int  list_laddrs(ipvs_zone_t *zone , int with_title);
	      ...
	      unsigned int *options, unsigned int *format)
{
	...
	struct poptOption options_table[] = {
		...
		{ "add-zone", 'K', POPT_ARG_NONE, NULL, 'K', NULL, NULL },
		{ "del-zone", 'V', POPT_ARG_NONE, NULL, 'V', NULL, NULL },
		...
		{ "zone", '\0', POPT_ARG_STRING, &optarg, TAG_ZONE, NULL, NULL },
	...
	while ((c=poptGetNextOpt(context)) >= 0){
		...
		case TAG_ZONE:
			...
			parse = parse_zone(optarg, &ce->zone);
			if (!(parse & ZONE_ADDR))
				fail(2, "illegal zone address,192.168.1.0/255.255.255.0 or 192.168.1.0/24");
			break;
...
static int process_options(int argc, char **argv, int reading_stdin)
{
	...
	case CMD_ADDZONE:
		result = ipvs_add_zone(&ce.zone);
		break;

	case CMD_DELZONE:
		result = ipvs_del_zone(&ce.zone);
		break;
		
	case CMD_ADDLADDR:
		result = ipvs_add_laddr(&ce.zone , &ce.laddr);
		break;

	case CMD_DELLADDR:
		result = ipvs_del_laddr(&ce.zone , &ce.laddr);
		break;

	case CMD_GETLADDR:
		if(options & OPT_ZONE)
			result = list_laddrs(&ce.zone , 1);
		else
...
int xtables_strtoul(const char *s, char **end, unsigned long *value,
...
int xtables_strtoui(const char *s, char **end, unsigned int *value,
...
static int 
parse_zone(char *name, ipvs_zone_t *zone)
{
	char *p, buf[256];
	struct in_addr addrp;
	...
	if ((p = strrchr(buf, '/')) != NULL) {
		*p = '\0';
		if(parse_ipmask(p + 1, &addrp))
			return ZONE_NONE;
	} else {
		if(parse_ipmask(NULL, &addrp))
			return ZONE_NONE;
	}
	zone->netmask = addrp.s_addr;
	if(ipparse_hostnetwork(buf, &addrp))
		return ZONE_NONE;
	//zone->addr = addrp.s_addr;
	zone->__addr_v4 = addrp.s_addr;
	zone->addr.ip = addrp.s_addr;
	zone->af = AF_INET;
	return ZONE_ADDR;
...
static void usage_exit(const char *program, const int exit_status)
{
	...
	fprintf(stream,
		...
		"  %s -S [-n]\n"
		"  %s -I/V src-zone"
		"  %s -P|Q --zone src-zone -z local-address\n"
		"  %s -G --zone src-zone \n"
	...
	fprintf(stream,
		...
		"  --add-zone        -K        add source address zone\n"
		"  --del-zone        -V        del source address zone\n"
...
static void list_laddrs_print_zone(struct ip_vs_get_laddrs *d)
{
	char *	vname;

	if (!(vname = addrnetmask_to_anyname(&d->addr.ip, &d->netmask)))
		fail(2, "addrport_to_anyname: %s", strerror(errno));	
...
static void print_zone_and_laddrs(struct ip_vs_get_laddrs* d, int with_title)
{
	int i = 0;
...
static int list_laddrs(ipvs_zone_t *zone , int with_title)
{
	ipvs_zone_entry_t *entry;
	struct ip_vs_get_laddrs *d;

	if (!(entry = ipvs_get_zone(zone->addr.ip, zone->netmask))) {
		//fprintf(stderr, "%s\n", ipvs_strerror(errno));
		return -1;
	}
	...
	print_zone_and_laddrs(d, with_title);
...
static int list_all_laddrs(void)
{
	...
	if (!(get = ipvs_get_zones())) {
		//fprintf(stderr, "%s\n", ipvs_strerror(errno));
		return -1;
	}

	for (i = 0; i < get->num_zones; i++){
		...
		if(i != 0)
			title_enable = 0;
		print_zone_and_laddrs(d, title_enable);
...
static char *
addrnetmask_to_anyname(__be32 *addr, __be32 *netmask)
{	
  char *buf, abuf[INET6_ADDRSTRLEN], nbuf[INET6_ADDRSTRLEN];
  
	if (!(buf=malloc(60)))
		return NULL;
	inet_ntop(AF_INET, addr, abuf, sizeof(abuf));
	inet_ntop(AF_INET, netmask, nbuf, sizeof(nbuf));
	snprintf(buf, 60, "%s/%s", abuf, nbuf);
